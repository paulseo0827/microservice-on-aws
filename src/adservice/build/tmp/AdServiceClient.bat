...
set DEFAULT_JVM_OPTS="-Dlog4j2.contextDataInjector=io.opencensus.contrib.logcorrelation.log4j2.OpenCensusTraceContextDataInjector" "-agentpath:/opt/cprof/profiler_java_agent.so=-cprof_service=adserviceclient,-cprof_service_version=1.0.0"
...
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %AD_SERVICE_CLIENT_OPTS%  -classpath "%CLASSPATH%" hipstershop.AdServiceClient %CMD_LINE_ARGS%
...
if  not "" == "%AD_SERVICE_CLIENT_EXIT_CONSOLE%" exit 1
exit /b 1
